...
class gameUI(arcade.View):
    ...
    def setup(self):
        ...
        self.ui_manager.add_ui_element(SinglePlayerButton(self.window.height // 2))
        self.ui_manager.add_ui_element(MultiPlayerButton(self.window.height // 3))
